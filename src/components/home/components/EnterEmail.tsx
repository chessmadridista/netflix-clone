...
function EnterEmail(): JSX.Element {
    return (
        <>
            ...
            <Card sx={{position: 'relative', minHeight: '100vh', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent', color: '#fff'}}>
                <CardHeader 
                    title={
