...
function EnterEmail(): JSX.Element {
    return (
        <>
            <img src="src/assets/EnterEmail.jpg" alt="Enter email background image." style={{ marginLeft: 0, position: 'absolute', height: '100%', width: '100%', opacity: '0.6', filter: 'blur(1px)'}} />
